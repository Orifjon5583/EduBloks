...
import { LayoutDashboard, Building2, Users, UsersRound, GraduationCap, Trophy, ShieldCheck, FileText, Bell, MessageCircle, LogOut, Sun, Moon } from 'lucide-react';
import NotificationBell from '../components/NotificationBell';
import MobileMenu from '../components/MobileMenu';

const links = [
  { to: '/admin', label: 'Dashboard', icon: LayoutDashboard, end: true },
  { to: '/admin/branches', label: 'Filiallar', icon: Building2 },
  ...
  { to: '/admin/rankings', label: 'Reytinglar', icon: Trophy },
  { to: '/admin/xp-approval', label: 'XP Tasdiqlash', icon: ShieldCheck },
        ...
        <div className="p-3 border-t border-gray-200 dark:border-gray-700 space-y-2">
          <div className="flex justify-between items-center px-3">
            ...
            <div className="flex items-center gap-2">
              <NavLink to="/admin/notifications"><NotificationBell /></NavLink>
